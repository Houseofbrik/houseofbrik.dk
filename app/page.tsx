...
function InfoPage({ label, title }: { label: string; title: string }) {
  ...
  return (
  <section className="relative z-10 flex min-h-screen items-center justify-center px-6 pb-16 pt-28 md:pt-32">
<div className="max-w-4xl -translate-y-4 rounded-[2rem] border border-[#F5F1E8]/10 bg-[#14251C]/80 px-8 pb-4 pt-8 text-center shadow-2xl shadow-black/30 backdrop-blur-md">        <p className="mb-3 text-sm uppercase tracking-[0.4em] text-[#7FA083]">
          {label}
        </p>
