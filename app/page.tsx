...
<div className="max-w-4xl -translate-y-4 rounded-[2rem] border border-[#F5F1E8]/10 bg-[#14251C]/80 px-8 py-4 text-center shadow-2xl shadow-black/30 backdrop-blur-md">
